...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "TestHMH22_CreateLearningObject.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class TestHMH22_CreateLearningObject extends com.hmh.automation.tools.AbstractBaseSiteTest {
    ...
    private String objectType, objectName, activityType, grade, language, folderType, folderName, aspectName, market, lifecycle, learningStyle,
            interactivityLevel, socialInteraction, rights, title, siteTypeTest, resourceType;

    String nameLabel = "Name";
    String gradeLabel = "Grade";
    String activityLabel = "Activity Type";
    ...
    @Test
    @Title("TestHMH22 - Create Learning Object")
    public void testHMH21_CreateLearningObject() {
