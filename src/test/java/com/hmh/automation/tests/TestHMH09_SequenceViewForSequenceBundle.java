...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "TestHMH09_SequenceViewForSequenceBundle.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class TestHMH09_SequenceViewForSequenceBundle extends com.hmh.automation.tools.AbstractBaseSiteTest {
    ...
    String type, actionName, objectName, markets, aspectName, folderType, folderName, title, siteTypeTest;
    ...
    @Test
    @Title("TestHMH09 - Sequence View for Sequence Bundle")
    public void testHMH09_SequenceViewForSequenceBundle() {
        siteHeaderSteps.clickOnDocumentLibraryButton();
        documentLibrarySteps.createNewContent(folderType);
        documentLibrarySteps.createFolder(folderName, "ctsQA");
        siteHeaderSteps.clickOnDocumentLibraryButton();
