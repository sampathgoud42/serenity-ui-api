...
@Story(HMHApplication.Sequence.class)
@RunWith(SerenityParameterizedRunner.class)
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "TestHMH17_CreateSequenceBundle.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class TestHMH17_CreateSequenceBundle extends com.hmh.automation.tools.AbstractBaseSiteTest {
    ...
    String type, objectName, markets, aspectName, folderType, folderName, title, siteTypeTest;
    ...
    @Test
    @Title("TestHMH17 - Create SqB")
    public void testHMH17_CreateSequenceBundle() {
        ...
        hmhDocumentLibrarySteps.createSequenceBundle(objectName, markets, title);
