...
@UseTestDataFrom(value = ConstantsHMH.CSV_FILES_BASE_PATH_HMH + "TestHMH08_SequenceViewForProductSet.csv", separator = ConstantsHMH.CSV_SEPARATOR)
public class TestHMH08_SequenceViewForProductSet extends com.hmh.automation.tools.AbstractBaseSiteTest {
    ...
    String type, year, grade, markets, label1, lable1Restart, actionName, objectName, aspectName,
            folderType, folderName, title, siteTypeTest;
    ...
    @Test
    @Title("TestHMH08 - Sequence View for Product Set")
    public void testHMH08_SequenceViewForProductSet() {
